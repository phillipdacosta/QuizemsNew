...
export class ProfessorComponent implements OnInit {
  ...
  populateQuiz(){
    ...
    if (typeof this.time === 'string'|| this.time instanceof String){

      alert('You entered a string for the time, not a number! Please enter a number!')
